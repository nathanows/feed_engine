...
RSpec.describe Api::V1::Migration::TweetsController, type: :controller do

  describe "GET index" do
    it "returns json" do
      tweet = create(:tweet, dataset: "migration")
      ...
      expect(data["tweets"].first["dataset"]).to eq("migration")
